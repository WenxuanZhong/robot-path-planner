...
(function () {
  ...
  var ALGO_NAMES = { astar: 'A*', dijkstra: 'Dijkstra', greedy: '贪婪' };
  ...
  function drawStart() {
    ...
    roundRect(x + 2, y + 2, CELL - 4, CELL - 4, 5); ctx.fill();
    ctx.fillStyle = '#fff';
    ctx.beginPath(); ctx.arc(x + CELL / 2, y + CELL / 2, CELL * 0.14, 0, Math.PI * 2); ctx.fill();
  }
  ...
  function drawRobot() {
    ...
    ctx.beginPath(); ctx.arc(x - CELL * 0.08, y - CELL * 0.08, CELL * 0.09, 0, Math.PI * 2); ctx.fill();
  }
